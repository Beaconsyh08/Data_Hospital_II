...
from data_hospital.dedup.imagededup.handlers.search.retrieval import HashEval
from data_hospital.dedup.imagededup.utils.general_utils import (
    get_files_to_remove,
    save_json,
    parallelise,
    generate_files,
...
from data_hospital.dedup.imagededup.utils.image_utils import load_image, preprocess_image, check_image_array_hash
from data_hospital.dedup.imagededup.utils.logger import return_logger
...
class Hashing:
    ...
    def encode_image(
        ...
        Example:
        ```
        from data_hospital.dedup.imagededup.methods import <hash-method>
...
class PHash(Hashing):
    ...
    from data_hospital.dedup.imagededup.methods import PHash
    phasher = PHash()
...
class AHash(Hashing):
    ...
    from data_hospital.dedup.imagededup.methods import AHash
    ahasher = AHash()
...
class DHash(Hashing):
    ...
    from data_hospital.dedup.imagededup.methods import DHash
    dhasher = DHash()
...
class WHash(Hashing):
    ...
    from data_hospital.dedup.imagededup.methods import WHash
    whasher = WHash()
